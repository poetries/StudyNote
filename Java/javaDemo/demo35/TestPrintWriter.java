...
public class TestPrintWriter
{
	public static void main (String[] args) {
		...
		try 
		{
			...
			PrintWriter out  = new PrintWriter(new FileWriter("f:/lianying.java"));  //new PrintWriter(new FileWriter("d:/haobin.java", true)); 加true参数表示数据追加到文件的末尾，没有true参数，表示直接覆盖掉原文件的内容
